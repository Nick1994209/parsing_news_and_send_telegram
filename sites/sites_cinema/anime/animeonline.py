...
class Animeonline:
    ...
    @classmethod
    def get_all_episodes(cls, page=1): # RSS
        URL = cls.SITE_URL + '/zend/episodes.xml'
        if page > 2:
            return []
    ...
    #         episode = {}
    #         episode['name_rus'] = anime_div_bs.find('span', {
    #             "class": "label_rus"}).decode_contents()
    #         episode['name_eng'] = anime_div_bs.find('span', {
    #             "class": "label_eng"}).decode_contents()
    #
